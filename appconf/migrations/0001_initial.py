# -*- coding: utf-8 -*-
# Generated by Django 1.11.16 on 2018-11-28 09:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('app_type', models.CharField(blank=True, choices=[('Frontend', 'Frontend'), ('Middleware', 'Middleware'), ('Backend', 'Backend'), ('Other', 'Other')], max_length=30, null=True, verbose_name='\u7a0b\u5e8f\u7c7b\u578b')),
                ('server_type', models.CharField(blank=True, choices=[('Tomcat', 'Tomcat'), ('Weblogic', 'Weblogic'), ('JETTY', 'JETTY'), ('Nginx', 'Nginx'), ('Gunicorn', 'Gunicorn'), ('Uwsgi', 'Uwsgi'), ('Apache', 'Apache'), ('IIS', 'IIS'), ('Other', 'Other')], max_length=30, null=True, verbose_name='\u670d\u52a1\u5668\u7c7b\u578b')),
