...
class AppOwner(models.Model):
    ...
    phone = models.CharField(u"手机", max_length=50, null=False, blank=False)
    email = models.EmailField(u'邮箱', max_length=100, blank=True, null=True)
    weChat = models.CharField(u"微信", max_length=100, null=True, blank=True)
